import{l as x,r as m,m as y,d as b,q as C,s as i,o as S,c as V,a as t,i as p,k as v,b as e,t as h,w as f,v as T,u as $}from"./index-481f74c1.js";import{_ as g}from"./CodeSnippet.vue_vue_type_style_index_0_lang-d731390e.js";const B=x("counter",()=>{const c=m(0),a=y(()=>c.value*2);function r(){c.value++}return{count:c,doubleCount:a,increment:r}}),k=e("h1",null,"Basic Page",-1),D=e("h2",null,"Some Basic Ref and Store behaviours",-1),I=e("h2",null,"Watchers",-1),N=e("p",null,"watcherCountText:",-1),O=e("p",null,"watchTotalsText:",-1),E=b({__name:"BasicView",setup(c){const a=B(),r=m(a.count),u=C({count:0}),_=()=>{a.increment()},l=m(""),d=m("");return i(r,async(n,o)=>{let w=new Date().toISOString();l.value="value goes from "+o+" to "+n+" at "+w}),i(()=>a.count,n=>{l.value=`count is now: ${n}`}),i(()=>u.count,n=>{l.value=`reactive count is: ${n}`}),i([r,()=>u.count,()=>a.count],(n,o)=>{let s=n[0]+n[1]+n[2],w=(o[0]??0)+(o[1]??0)+(o[2]??0);d.value=`sum is: ${s} (old sum is ${w})`},{immediate:!0}),(n,o)=>(S(),V("main",null,[k,t(),D,t(),p(g,{title:"setup"},{default:v(()=>[t(`import { ref, watch, reactive } from 'vue'\r
...
const watchTotalsText = ref('')`)]),_:1}),t(),e("p",null,`\r
    ...
    `)]),t(),e("p",null,"The Store value can be referenced directly as "+h($(a).count)+".",1),t(),e("p",null,[t(`\r
      ...
      `),e("button",{onClick:_},"Increment Counter")]),t(),e("p",null,[t("This is a ad-hoc reactive property "),f(e("input",{type:"number","onUpdate:modelValue":o[1]||(o[1]=s=>u.count=s)},null,512),[[T,u.count]])]),t(),I,t(),p(g,{title:"watcher setup"},{default:v(()=>[t(`const watcherCountText = ref('')\r
